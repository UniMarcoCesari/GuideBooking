...
public class Sezione3 extends JFrame {
    ...
    private Month calculateSelectedMonth() {
        return calendarioController.getNomeMesePrimoCheSiPuoModificare().plus(2);
    }
    ...
    private JPanel createHeaderPanel() {
        String monthName = selectedMonth.getDisplayName(TextStyle.FULL, ITALIAN_LOCALE);
    ...
    private void validateAndAddDate(LocalDate inputDate) {
        ...
        if (inputDate.getMonth() != selectedMonth) {
    ...
    private void loadPrecludedDates() {
        ...
        List<LocalDate> precludedDates = calendarioController.getDatePrecluse(selectedMonth.getValue());
